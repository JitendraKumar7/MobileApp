...
class AddPurchaseOrderPage extends StatefulWidget {
  ...
  const AddPurchaseOrderPage(this.document, {Key? key}) : super(key: key);
  ...
  @override
  State<AddPurchaseOrderPage> createState() => _PurchaseOrderState();
}

class _PurchaseOrderState extends State<AddPurchaseOrderPage> {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          ElevatedButton(
            onPressed: () async {
              db.getPurchaseOrder(reference).add(modal);
