...
class FirestoreServices {
  ...
  /* Addon <Start> */
  CollectionReference<OrderModal> getSalesOrder(DocumentReference reference) {
  ...
  CollectionReference<ProformaModal> getProforma(DocumentReference reference) {
    return reference
  ...
  CollectionReference<OrderModal> getPurchaseOrder(
      DocumentReference reference) {
  ...
  CollectionReference<QuotationModal> getQuotation(
      DocumentReference reference) {
